...
class AwsTcoBvaAnalyst:
    ...
    def _get_tools(self, mcp_tools: list = None) -> list:
    ...
    def _create_agent(self, mcp_tools: list = None, messages: list = None, interactive: bool = False) -> Agent:
        """Create a fresh Strands agent with cached model/tools and optional conversation history.
        
        Args:
            mcp_tools: MCP tools to include
            messages: Previous conversation history
            interactive: If True, use default printing callback handler
        """
        kwargs = dict(
